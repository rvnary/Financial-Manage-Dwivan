    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl mb-6 text-white">Smart Financial Planning</h1>

          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Take control of your finances with our intelligent money management
            tool. Calculate your remaining budget and get personalized
            investment recommendations to make your money work for you.
            <br />
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20 max-w-5xl mx-auto">
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700">
            ...
            <p className="text-gray-400">
              Easily input your monthly salary and categorize your expenses to
          ...
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700">
            ...
            <p className="text-gray-400">
              Automatically calculate how much money you have left after all
          ...
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700">
            ...
            <p className="text-gray-400">
              Get smart suggestions on where to invest your remaining money for
              optimal growth.
            </p>
          </div>
        </div>
