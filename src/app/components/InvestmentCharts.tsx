  ...
  const investments: InvestmentOption[] = [
    {
      ...
      color: "#ccff33",
      description:
        "Cryptocurrency with high volatility and potential for significant returns",
    },
    {
    ...
    },
    {
      ...
      color: "#38b000",
      description:
        "Technology-focused ETF with exposure to high-growth companies",
    },
  ];
  ...
  return (
    <div className="space-y-6 mt-8">
      ...
      <p className="text-gray-400">
        Based on market analysis, here are top investment recommendations with
        expected returns
      </p>
            ...
            <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className="font-medium text-white">
                        $
                        {(remainingMoney * 0.3).toLocaleString(undefined, {
                    ...
                    <div>
                      ...
                      <div className="font-medium" style={{ color: "#70e000" }}>
                        $
                        {calculatePotentialReturn(investment).toLocaleString(
                          undefined,
                          { maximumFractionDigits: 0 }
                        )}
                      </div>
              ...
              >
                <p className="text-sm text-gray-300">
                  ...
                  You should invest in {investment.name}, because the expected
                  return is{" "}
      ...
      <div className="bg-amber-950 border border-amber-800 rounded-lg p-4">
        ...
        <p className="text-sm text-amber-300">
          ...
          <span className="block mt-2">
            Project Tugas ini adalah contoh edukasi saja dan bukan merupakan
            nasihat keuangan. Semua investasi mengandung risiko. Mohon
            konsultasikan dengan penasihat keuangan yang berkualifikasi sebelum
            membuat keputusan untuk ber-investasi.
          </span>
        </p>
      </div>
    </div>
